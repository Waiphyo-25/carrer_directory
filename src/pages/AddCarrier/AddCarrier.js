...
const AddCarrier = () => {
  ...
  return (
    <Layout>
      <div className="add-carrier ui text container">
        ...
        <div className="field">
          <label>State</label>
          <div onBlur={ () => setStateActive(false)} onClick={toggleState} className="ui fluid dropdown selection" tabindex="0">
              <select>
        ...
        <div class="add-carrier__btn ui button" tabIndex="0">Add carrier</div>
            </form>
